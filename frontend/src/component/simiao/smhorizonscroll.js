                            ...
                            <ul style={{ padding: '5px', listStyleType: "none", clear: 'both', height: "160px" }}>
                                {
                                    related.map((redata,i) => {
                                        return <li style={{ float: 'left', width: '200px', height: '150px', marginLeft: '10px' }} key={i}>
                                            <img style={{ width: '200px', height: '102px' }} src={redata.banner} onClick={oncardclick.bind(this, redata)} />
                                            <WhiteSpace size="xs" />
                                            <div className="yx-news-category" style={{fontSize:'14px'}}>{redata.views+'人关注,'+redata.follows+'次浏览'}</div>
                                            <WhiteSpace size="xs" />
                                            <div className='yx-detail-title'>{redata.name}</div>
                                        </li>
                                    })}
                            </ul>
                        </div>
